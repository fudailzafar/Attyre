...
const ColourSection = () => {
  return (
    <div className="w-[100%] flex flex-row gap-3 md:gap-10 py-5">
      <div className="w-full">
        <div className="px-[50px] md:px-[90px] py-[70px] md:py-[100px] bg-[#228B22]"></div>
        <div>
      ...
      <div className="w-full">
        <div className="px-[50px] md:px-[90px] py-[70px] md:py-[100px] bg-[#B7410E]"></div>
        <div>
